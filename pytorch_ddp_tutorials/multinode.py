...
class Trainer:
    def __init__(
        ...
        # rank of process locally on a single node (machine)
        self.local_rank = int(os.environ["LOCAL_RANK"])
        # each process have rank and it set by torch run & global rank overall process rank
    ...
    def _run_epoch(self, epoch):
        ...
        # logging satatement is using glboal rank instead of local rank
        print(
